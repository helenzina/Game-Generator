...
public class PointsCard implements CardService{
    ...
    public PointsCard(int id, String message, String parameter, int value) {
        this.id = id;
    ...
    public void executeSpecificCard(Player player, List<Player> players){
            ...
            System.out.println(player.getName() + " got " + this.value + " points and now they have " + player.getPoints() + ".");
    }
