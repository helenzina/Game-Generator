...
public class ChangeTileMaxPCard implements CardService {
    private int id;
    private String message;
    private String parameter;
    private int value;

    public ChangeTileMaxPCard(int id, String message, String parameter, int value) {
        this.id = id;
    ...
    public void executeSpecificCard(Player player, List<Player> players){
        ...
        System.out.println("Action of card: " + this.message);
            if (player.getPoints() == sortedPlayers.get(sortedPlayers.size() - 1).getPoints()) {
                System.out.println(player.getName() + ", you have the maximum amount of points.");
            } else {
                ...
                System.out.println(player.getName() + " changed position with " + sortedPlayers.get(sortedPlayers.size() - 1).getName() + " as they had the maximum amount of points.");
            }
    }
